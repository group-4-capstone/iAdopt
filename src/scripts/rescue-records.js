            ...
            if (response.data.length > 0) {
                for (var count = 0; count < response.data.length; count++) {
                    ...
                    if (statusDisplay === "Adoptable") {
                        ...
                        statusDisplay = '<span class="badge bg-danger text-light">Under Review</span>'; // Red badge
                    } else if (statusDisplay === "Unadoptable") {
                        statusDisplay = '<span class="badge bg-secondary text-light">Unadoptable</span>'; // Gray badge
                    }
