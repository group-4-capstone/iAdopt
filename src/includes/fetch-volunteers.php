...
for ($count = 0; $count < count($page_array); $count++) {
    if ($page == $page_array[$count]) {
        ...
        if ($previous_id > 0) {
            $previous_link = '<li><a href="javascript:load_data_volunteers(`'.$_POST["query"].'`, '.$previous_id.')">&lt;</a></li>';
        } else {
            $previous_link = '
				<li class="disabled">
			        <a href="#">&lt;</a>
        ...
        if ($next_id > $total_links) {
            ...
            $next_link = '
				<li><a href="javascript:load_data_volunteers(`'.$_POST["query"].'`, '.$next_id.')">&gt;</a></li>
			';
        }
        ...
        if ($page_array[$count] == '...') {
            ...
            $page_link .= '
				<li>
					<a href="javascript:load_data_volunteers(`'.$_POST["query"].'`, '.$page_array[$count].')">'.$page_array[$count].'</a>
				</li>
			';
        }
    }
