...
if(isset($_POST["query"]))
{
	...
	if($_POST["query"] != '')
	{
		...
		WHERE question LIKE :question OR status LIKE :status
		";
	...
	for($count = 0; $count < count($page_array); $count++)
	{
		if($page == $page_array[$count])
		{
			...
			if($previous_id > 0)
			{
				$previous_link = '<li class="page-item"><a class="page-link" href="javascript:load_data_faq(`'.$_POST["query"].'`, '.$previous_id.')"><</a></li>';
			}
			else
			{
				$previous_link = '
			...
			{
				$next_link = '
				<li class="page-item"><a class="page-link" href="javascript:load_data_faq(`'.$_POST["query"].'`, '.$next_id.')">></a></li>
				';
			}
		...
		else
		{
			...
			else
			{
				$page_link .= '
				<li class="page-item">
					<a class="page-link" href="javascript:load_data_faq(`'.$_POST["query"].'`, '.$page_array[$count].')">'.$page_array[$count].'</a>
				</li>
				';
			}
		}
